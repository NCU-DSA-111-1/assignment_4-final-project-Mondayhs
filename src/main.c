...
int main(void)
{
    ...
    printf("\n\033[37m============================================================================================================\033[0m\n");
    printf("\033[37m|\033[0m     21點是一種經典的扑克牌遊戲，每局的目的是讓手中的牌點數加起來等於或接近21點，但不能超過21點。         \033[37m|\033[0m\n");
    printf("\033[37m|\033[0m     遊戲開始後，玩家先行動，可以選擇要牌或停牌。若玩家選擇要牌，庄家就會從牌堆中給玩家一張牌             \033[37m|\033[0m\n");
    printf("\033[37m|\033[0m     ，玩家的牌點數會隨之增加。玩家可以一直要牌直到他們的牌點數等於或超過21點，此時玩家爆牌了，失去本局。 \033[37m|\033[0m\n");
    printf("\033[37m|\033[0m     最後，玩家和庄家的牌點數會被比較，如果玩家的牌點數比庄家高，玩家贏得本局；                           \033[37m|\033[0m\n");
    printf("\033[37m|\033[0m     如果玩家的牌點數等於庄家的牌點數，則是和局；否則庄家贏。                                             \033[37m|\033[0m\n");
